...
(function() {
  var bing, bing_map, build_gallery, build_pups, circleGeometry, cities, close_menu, ellipsoid, fly_to_Russia, get_oopt_rect, handler, load_borders, load_cities, load_np, load_zp, num_images, oopt, open_info_popup, open_menu, open_photo_popup, open_video_popup, open_web_popup, osm, osm_map, pole_primitive, primitives, redCircleInstance, resize, scene, selected_polygon_name, showed_image, viewer;
  ...
  $('.photos_right').on('click', function(e) {
    ...
    if (showed_image !== 4) {
      showed_image++;
      $('.photo_container img').hide();
      return $('.photo_container img').eq(showed_image).show();
    }
  });
