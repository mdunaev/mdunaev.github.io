...
(function() {
  var bing, bing_map, build_pups, circleGeometry, cities, close_menu, ellipsoid, fly_to_Russia, get_oopt_rect, handler, load_borders, load_cities, load_np, load_zp, oopt, open_menu, osm, osm_map, pole_primitive, primitives, redCircleInstance, resize, scene, selected_polygon_name, viewer;
