...
(function() {
  var autoplay, close_popup, current_scene, enter_frame_handler, floors, goto_next, goto_prev, iframes_loaded, init, is_autoplay, is_first_frame, is_next_play, move_scroll_to_position, open_popup, points, set_floor_height, start, timeStamp, wait_while_all_loaded;
  ...
  points = {
    ...
    'floor2': [0, 0, 0, 0, 0],
    'floor1': [200, 200, 200, 200, 200, 200, 200, 200, 0],
    'floor0': [0]
  };
