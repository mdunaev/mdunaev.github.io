   ...
   content: {
         dom: [
         {
            ...
            },
            {
               id:'moon',
               type:'image',
               rect:['1800px','auto','73px','73px','auto','692px'],
               fill:["rgba(0,0,0,0)",'moon.svg','0px','0px']
            },
            {
               id:'rain2',
               type:'rect',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid183", tween: [ "style", "${_sand_center}", "bottom", '368px', { fromValue: '567px'}], position: 2750, duration: 202 },
            { id: "eid187", tween: [ "style", "${_sand_center}", "bottom", '432px', { fromValue: '368px'}], position: 2952, duration: 682 },
            ...
            { id: "eid182", tween: [ "style", "${_sand_center}", "height", '208px', { fromValue: '9px'}], position: 2750, duration: 202 },
            { id: "eid186", tween: [ "style", "${_sand_center}", "height", '144px', { fromValue: '208px'}], position: 2952, duration: 682 },
            { id: "eid184", tween: [ "style", "${_sand_center}", "height", '0px', { fromValue: '144px'}], position: 3634, duration: 52 },
            ...
            { id: "eid181", tween: [ "style", "${_Symbol_1Copy}", "bottom", '542px', { fromValue: '542px'}], position: 2633, duration: 0 },
            { id: "eid180", tween: [ "style", "${_Symbol_1Copy2}", "bottom", '425px', { fromValue: '425px'}], position: 2633, duration: 0 },
            ...
            { id: "eid177", tween: [ "style", "${_man-stand2}", "clip", [0,53,-3,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [0,53,64,0]}], position: 2952, duration: 771 },
...
"Legs": {
   ...
   },
   {
      type: 'image',
      display: 'none',
      rect: ['18px','auto','24px','27px','auto','8px'],
      id: 'man-legs-STND',
      fill: ['rgba(0,0,0,0)','images/man-legs-STND.svg','0px','0px']
   }],
   symbolInstances: [
   ]
   },
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid178", tween: [ "style", "${_man-legs-STND}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid179", tween: [ "style", "${_man-legs-STND}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0 }         ]
      }
   }
},
"Symbol_1": {
