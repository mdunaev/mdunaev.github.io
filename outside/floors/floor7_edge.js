   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid239", tween: [ "style", "${_ok}", "display", 'none', { fromValue: 'block'}], position: 1000, duration: 0 },
            { id: "eid240", tween: [ "style", "${_ok}", "display", 'block', { fromValue: 'none'}], position: 1500, duration: 0 }         ]
      }
   }
}
};
