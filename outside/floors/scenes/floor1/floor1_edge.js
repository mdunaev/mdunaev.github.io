...
"stage": {
   ...
   content: {
         dom: [
         {
            id:'static_bg',
            type:'group',
            rect:['0','auto','4212','787','auto','80px'],
            c:[
            {
               id:'man-fly',
               type:'image',
         ...
         },
         {
            ...
            display:'none',
            type:'image',
            rect:['1448px','auto','82px','8.9%','auto','457px'],
            fill:["rgba(0,0,0,0)",im+"man-fly.svg",'0px','0px']
         },
         {
            id:'man-stand2',
         ...
         },
         {
            id:'brics2',
            type:'image',
            rect:['-1px','auto','1841px','287px','auto','-2px'],
            fill:["rgba(0,0,0,0)",im+"brics.svg",'0px','0px']
         },
         {
            id:'brics2Copy',
            type:'image',
            rect:['1446px','auto','1841px','287px','auto','-2px'],
            fill:["rgba(0,0,0,0)",im+"brics.svg",'0px','0px']
         },
         {
            id:'letters',
            type:'image',
            rect:['595px','auto','1808px','271px','auto','-13px'],
            fill:["rgba(0,0,0,0)",'svgs/l1-svg/letters.svg','0px','0px']
         }],
         symbolInstances: [
         {
            id:'Symbol_1Copy2',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid162", tween: [ "style", "${_man-fly2}", "bottom", '648px', { fromValue: '820px'}], position: 1467, duration: 274, easing: "easeOutQuad" },
            { id: "eid163", tween: [ "style", "${_man-fly2}", "bottom", '568px', { fromValue: '648px'}], position: 1741, duration: 9, easing: "easeOutQuad" },
            ...
            { id: "eid61", tween: [ "style", "${_man-fly3}", "bottom", '339px', { fromValue: '537px'}], position: 2695, duration: 243 },
            { id: "eid164", tween: [ "style", "${_man-fly3}", "bottom", '243px', { fromValue: '339px'}], position: 2938, duration: 14 },
            { id: "eid58", tween: [ "style", "${_man-fly3}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid57", tween: [ "style", "${_man-fly3}", "display", 'block', { fromValue: 'none'}], position: 2695, duration: 0 },
            { id: "eid62", tween: [ "style", "${_man-fly3}", "display", 'none', { fromValue: 'block'}], position: 2952, duration: 0 },
