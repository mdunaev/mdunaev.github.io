   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid99", tween: [ "style", "${_ball-pink}", "bottom", '430px', { fromValue: '300px'}], position: 9500, duration: 1500 },
            ...
            { id: "eid103", tween: [ "style", "${_ball-orange}", "bottom", '474px', { fromValue: '344px'}], position: 9500, duration: 1500 },
